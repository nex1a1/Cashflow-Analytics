...
function getSavingsGrade(savingsRate: number) {
...
function getSavingsRateStyle(savingsRate: number) {
...
interface LedgerHeaderActionsProps {
...
const LedgerHeaderActions: React.FC<LedgerHeaderActionsProps> = ({
  viewMode,
  setViewMode,
  filterOpen,
  setFilterOpen,
...
interface LedgerCommandPanelProps {
  sumInc: number;
  sumExp: number;
  net: number;
  savingsRate: number;
...
const LedgerCommandPanel: React.FC<LedgerCommandPanelProps> = ({
  sumInc,
  sumExp,
  net,
  savingsRate,
...
interface LedgerGroupBreakdownSectionProps {
  activeIncomeCards: React.ReactNode[];
  activeSavingsCards: React.ReactNode[];
  activeExpenseCards: React.ReactNode[];
}

const LedgerGroupBreakdownSection: React.FC<LedgerGroupBreakdownSectionProps> = ({
  activeIncomeCards,
  activeSavingsCards,
  activeExpenseCards
}) => {
...
interface LedgerContentAreaProps {
...
const LedgerContentArea: React.FC<LedgerContentAreaProps> = ({
  showSkeleton,
  displayTransactions,
  monthTransactions,
  horizontalFilters,
