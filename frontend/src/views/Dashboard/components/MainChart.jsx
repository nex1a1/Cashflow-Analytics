...
const MainChartHeader = ({
  ...
  return (
    <div className={`flex items-center justify-between gap-3 border-b mb-3 pb-3 ${'border-[#303030]/60'} flex-wrap relative z-20`}>
      <h3 className={cardHd}>
      ...
      <div className="flex items-center gap-2 flex-wrap">
        ...
        {chartViewType !== 'sankey' && !filterPeriod.match(/^\d{4}-\d{2}$/) && (
          <div className={`flex p-0.5 rounded-sm border shadow-sm ${'bg-[#181818] border-[#303030]/60'}`}>
            <button onClick={() => setChartGroupBy('monthly')} className={`px-3 py-1.5 text-[11px] font-bold rounded-sm transition-all ${chartGroupBy === 'monthly' ? ('bg-[#303030] text-[#da291c] shadow-sm') : ('text-slate-400 hover:text-slate-200 hover:bg-[#303030]/50')}`}>รายเดือน</button>
            <button onClick={() => setChartGroupBy('daily')} className={`px-3 py-1.5 text-[11px] font-bold rounded-sm transition-all ${chartGroupBy === 'daily' ? ('bg-[#303030] text-[#da291c] shadow-sm') : ('text-slate-400 hover:text-slate-200 hover:bg-[#303030]/50')}`}>รายวัน</button>
          </div>
        )}
        ...
        <div className={`flex p-0.5 rounded-sm border shadow-sm ${'bg-[#181818] border-[#303030]/60'}`}>
          <button
            ...
            className={`flex items-center gap-1.5 px-3 py-1.5 text-[11px] font-bold rounded-sm transition-all ${chartViewType === 'line' ? ('bg-[#303030] text-[#da291c] shadow-sm') : ('text-slate-400 hover:text-slate-200 hover:bg-[#303030]/50')}`}
          >
            <TrendingUp className="w-3.5 h-3.5" /> เส้น
          </button>
          <button
            onClick={() => setChartViewType('bar')}
            className={`flex items-center gap-1.5 px-3 py-1.5 text-[11px] font-bold rounded-sm transition-all ${chartViewType === 'bar' ? ('bg-[#303030] text-[#da291c] shadow-sm') : ('text-slate-400 hover:text-slate-200 hover:bg-[#303030]/50')}`}
          >
            <BarChart className="w-3.5 h-3.5" /> แท่ง
          </button>
          <button
            onClick={() => { setChartViewType('sankey'); setIsBreakdown(false); }}
            className={`flex items-center gap-1.5 px-3 py-1.5 text-[11px] font-bold rounded-sm transition-all ${chartViewType === 'sankey' ? ('bg-[#303030] text-[#da291c] shadow-sm') : ('text-slate-400 hover:text-slate-200 hover:bg-[#303030]/50')}`}
          >
        ...
        {chartViewType === 'sankey' && (
          <div className={`flex p-0.5 rounded-sm border shadow-sm ${'bg-[#181818] border-[#303030]/60'}`}>
            <button 
              ...
              className={`px-3 py-1.5 text-[10px] font-bold rounded-sm transition-all ${sankeySortMode === 'value' ? ('bg-[#303030] text-[#da291c] shadow-sm') : ('text-slate-400 hover:text-slate-200 hover:bg-[#303030]/50')}`}
            >
              เรียงตามยอดเงิน
            </button>
            <button 
              onClick={() => setSankeySortMode('index')} 
              className={`px-3 py-1.5 text-[10px] font-bold rounded-sm transition-all ${sankeySortMode === 'index' ? ('bg-[#303030] text-[#da291c] shadow-sm') : ('text-slate-400 hover:text-slate-200 hover:bg-[#303030]/50')}`}
            >
...
export default function MainChart() {
  ...
  const card = `rounded-sm border shadow-sm transition-colors h-full flex flex-col ${'bg-[#181818] border-[#303030]'}`;
    ...
    <div className={`${card} p-5 min-h-0`}>
      ...
      <div className="flex items-center justify-between gap-3 mb-3 relative z-10 flex-wrap w-full">
        ...
        {chartViewType !== 'sankey' && (
          <div className="flex items-center gap-2 flex-wrap">
             {chartViewType === 'line' && (
              <div className={`flex p-0.5 rounded-sm border shadow-sm ${'bg-[#181818] border-[#303030]'}`}>
                <button disabled={showSkeleton} onClick={() => setIsSmoothLine(false)} className={`flex items-center gap-1.5 px-3 py-1.5 text-[11px] font-bold rounded-sm transition-all ${!isSmoothLine ? ('bg-[#303030] text-[#da291c] shadow-sm') : ('text-slate-400 hover:text-slate-200 hover:bg-[#303030]/50')}`}>
                ...
                <button disabled={showSkeleton} onClick={() => setIsSmoothLine(true)} className={`flex items-center gap-1.5 px-3 py-1.5 text-[11px] font-bold rounded-sm transition-all ${isSmoothLine ? ('bg-[#303030] text-[#da291c] shadow-sm') : ('text-slate-400 hover:text-slate-200 hover:bg-[#303030]/50')}`}>
      ...
      <div className="relative w-full flex-1 min-h-[350px]">
        {showSkeleton ? (
          <div className={`absolute inset-0 rounded-sm animate-pulse ${'bg-[#303030]/40'}`} />
        ) : (
