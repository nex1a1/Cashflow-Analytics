  ...
  return (
    <div className="w-full flex flex-col gap-3">
      ...
      <div className="w-full flex gap-3">
        <div className="w-[300px] shrink-0 flex flex-col rounded-none overflow-hidden border border-[#2d2d2d] bg-[#181818] shadow-sm">
          <SummaryVitals analytics={analytics as SummaryAnalytics} showSkeleton={showSkeleton} />
        </div>

        <div className="flex-1 min-w-0 flex flex-col rounded-none overflow-hidden border border-[#2d2d2d] bg-[#181818] shadow-sm">
