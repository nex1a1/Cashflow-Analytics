...
export const StrategicRentCard = memo(({ rentPercentageNum, rentTotal, rentSub, showSkeleton }: RentCardProps) => {
  ...
  return (
    <StrategicCardShell
      ...
      overlayBadge={<span className="text-sky-400 font-extrabold text-[9px] border border-sky-500/30 bg-sky-950/40 px-1.5 py-0.5 rounded-none leading-none whitespace-nowrap shrink-0">4 หมวด</span>}
      overlayBody={rentSub && (
