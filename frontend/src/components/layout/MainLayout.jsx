...
export default function MainLayout({ controller }) {
  ...
  return (
    ...
    >
      <div className={`max-w-[98%] xl:max-w-[1400px] 2xl:max-w-[1600px] w-full mx-auto my-4 border-t-4 border-[#00509E] shadow-xl rounded-xl flex-grow flex flex-col overflow-y-auto custom-scrollbar relative transition-colors duration-300 scroll-smooth ${'bg-slate-900'}`} style={{ scrollbarGutter: 'stable' }}>
