        ...
        <div className={`flex flex-col w-full md:w-3/5 border-b md:border-b-0 md:border-r ${border} h-[50vh] md:h-auto`}>
          ...
          <div className={`border-t ${border} px-4 pt-4 pb-5 space-y-2.5 shrink-0 ${surfaceAlt}`}>
            ...
            <button
              ...
              className={`w-full mt-2 py-2.5 rounded-xl font-bold text-sm flex items-center justify-center gap-2 transition-all active:scale-95 disabled:opacity-50 text-white shadow-sm ${
                formType === 'expense'
