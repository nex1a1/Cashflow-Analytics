...
const ExportHeader = ({ onClose, isExporting }) => (
...
const ExportFormatOption = ({ formatKey, activeFormat, onClick, icon: Icon, title, description }) => {
...
const ExportLongPreview = ({ dataToExport, categories, getDayTypeInfo }) => (
...
const ExportFullPreview = ({ localTransactions, categories, dayTypes, dayTypeConfig }) => (
...
const ExportLoadingOverlay = ({ isExporting }) => (
  <AnimatePresence>
    {isExporting && (
      <motion.div 
        initial={{ opacity: 0 }} 
